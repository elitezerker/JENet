...
class constants$217 {
    ...
    static final MethodHandle TerminateProcess$MH = RuntimeHelper.downcallHandle(
        "TerminateProcess",
        constants$217.TerminateProcess$FUNC
    );
    ...
    static final MethodHandle GetExitCodeProcess$MH = RuntimeHelper.downcallHandle(
        "GetExitCodeProcess",
        constants$217.GetExitCodeProcess$FUNC
    );
    ...
    static final MethodHandle SwitchToThread$MH = RuntimeHelper.downcallHandle(
        "SwitchToThread",
        constants$217.SwitchToThread$FUNC
    );
    ...
    static final MethodHandle CreateThread$MH = RuntimeHelper.downcallHandle(
        "CreateThread",
        constants$217.CreateThread$FUNC
    );
    ...
    static final MethodHandle CreateRemoteThread$MH = RuntimeHelper.downcallHandle(
        "CreateRemoteThread",
        constants$217.CreateRemoteThread$FUNC
    );
    ...
    static final MethodHandle GetCurrentThread$MH = RuntimeHelper.downcallHandle(
        "GetCurrentThread",
        constants$217.GetCurrentThread$FUNC
    );
}
