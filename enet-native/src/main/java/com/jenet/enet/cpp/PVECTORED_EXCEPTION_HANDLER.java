...
public interface PVECTORED_EXCEPTION_HANDLER {
    ...
    static MemorySegment allocate(PVECTORED_EXCEPTION_HANDLER fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PVECTORED_EXCEPTION_HANDLER.class, fi, constants$158.PVECTORED_EXCEPTION_HANDLER$FUNC, session);
    }
    static PVECTORED_EXCEPTION_HANDLER ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _ExceptionInfo) -> {
            try {
                return (int)constants$158.PVECTORED_EXCEPTION_HANDLER$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_ExceptionInfo);
            } catch (Throwable ex$) {
