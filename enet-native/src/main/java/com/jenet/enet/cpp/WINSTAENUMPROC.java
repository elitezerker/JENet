...
public interface WINSTAENUMPROC {
    ...
    static MemorySegment allocate(WINSTAENUMPROC fi, MemorySession session) {
        return RuntimeHelper.upcallStub(WINSTAENUMPROC.class, fi, constants$451.WINSTAENUMPROC$FUNC, session);
    }
    static WINSTAENUMPROC ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$452.WINSTAENUMPROC$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
