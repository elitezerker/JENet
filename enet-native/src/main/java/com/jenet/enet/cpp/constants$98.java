...
class constants$98 {
    ...
    static final MethodHandle MultiplyExtract128$MH = RuntimeHelper.downcallHandle(
        "MultiplyExtract128",
        constants$98.MultiplyExtract128$FUNC
    );
    ...
    static final MethodHandle UnsignedMultiplyExtract128$MH = RuntimeHelper.downcallHandle(
        ...
        constants$98.UnsignedMultiplyExtract128$FUNC
    );
    ...
    static final MethodHandle __readgsbyte$MH = RuntimeHelper.downcallHandle(
        "__readgsbyte",
        constants$98.__readgsbyte$FUNC
    );
    ...
    static final MethodHandle __readgsword$MH = RuntimeHelper.downcallHandle(
        "__readgsword",
        constants$98.__readgsword$FUNC
    );
    ...
    static final MethodHandle __readgsdword$MH = RuntimeHelper.downcallHandle(
        "__readgsdword",
        constants$98.__readgsdword$FUNC
    );
}
