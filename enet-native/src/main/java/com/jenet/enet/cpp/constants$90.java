...
class constants$90 {
    ...
    static final MethodHandle _InterlockedIncrement64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$90._InterlockedIncrement64$FUNC
    );
    ...
    static final MethodHandle _InterlockedDecrement64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$90._InterlockedDecrement64$FUNC
    );
    ...
    static final MethodHandle _InterlockedExchange64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$90._InterlockedExchange64$FUNC
    );
    ...
    static final MethodHandle _InterlockedExchangeAdd64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$90._InterlockedExchangeAdd64$FUNC
    );
    ...
    static final MethodHandle _InlineInterlockedAdd64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$90._InlineInterlockedAdd64$FUNC
    );
    ...
    static final MethodHandle _InterlockedCompareExchange64$MH = RuntimeHelper.downcallHandle(
        ...
        constants$90._InterlockedCompareExchange64$FUNC
    );
}
