...
class constants$566 {
    ...
    static final MethodHandle GetListBoxInfo$MH = RuntimeHelper.downcallHandle(
        "GetListBoxInfo",
        constants$566.GetListBoxInfo$FUNC
    );
    ...
    static final MethodHandle LockWorkStation$MH = RuntimeHelper.downcallHandle(
        "LockWorkStation",
        constants$566.LockWorkStation$FUNC
    );
    ...
    static final MethodHandle UserHandleGrantAccess$MH = RuntimeHelper.downcallHandle(
        ...
        constants$566.UserHandleGrantAccess$FUNC
    );
    ...
    static final MethodHandle GetRawInputData$MH = RuntimeHelper.downcallHandle(
        "GetRawInputData",
        constants$566.GetRawInputData$FUNC
    );
    ...
    static final MethodHandle GetRawInputDeviceInfoA$MH = RuntimeHelper.downcallHandle(
        ...
        constants$566.GetRawInputDeviceInfoA$FUNC
    );
    ...
    static final MethodHandle GetRawInputDeviceInfoW$MH = RuntimeHelper.downcallHandle(
        ...
        constants$566.GetRawInputDeviceInfoW$FUNC
    );
}
