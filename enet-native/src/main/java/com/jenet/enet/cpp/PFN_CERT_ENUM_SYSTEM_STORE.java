...
public interface PFN_CERT_ENUM_SYSTEM_STORE {
    ...
    static MemorySegment allocate(PFN_CERT_ENUM_SYSTEM_STORE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_ENUM_SYSTEM_STORE.class, fi, constants$815.PFN_CERT_ENUM_SYSTEM_STORE$FUNC, session);
    }
    static PFN_CERT_ENUM_SYSTEM_STORE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pvSystemStore, int _dwFlags, java.lang.foreign.MemoryAddress _pStoreInfo, java.lang.foreign.MemoryAddress _pvReserved, java.lang.foreign.MemoryAddress _pvArg) -> {
            try {
                return (int)constants$816.PFN_CERT_ENUM_SYSTEM_STORE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pvSystemStore, _dwFlags, (java.lang.foreign.Addressable)_pStoreInfo, (java.lang.foreign.Addressable)_pvReserved, (java.lang.foreign.Addressable)_pvArg);
            } catch (Throwable ex$) {
