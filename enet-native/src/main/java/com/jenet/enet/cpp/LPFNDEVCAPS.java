...
public interface LPFNDEVCAPS {
    ...
    static MemorySegment allocate(LPFNDEVCAPS fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPFNDEVCAPS.class, fi, constants$389.LPFNDEVCAPS$FUNC, session);
    }
    static LPFNDEVCAPS ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, int __x2, java.lang.foreign.MemoryAddress __x3, java.lang.foreign.MemoryAddress __x4) -> {
            try {
                return (int)constants$389.LPFNDEVCAPS$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, __x2, (java.lang.foreign.Addressable)__x3, (java.lang.foreign.Addressable)__x4);
            } catch (Throwable ex$) {
