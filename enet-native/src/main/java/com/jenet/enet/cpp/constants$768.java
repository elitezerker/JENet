...
class constants$768 {
    ...
    static final MethodHandle CryptEnumProvidersA$MH = RuntimeHelper.downcallHandle(
        "CryptEnumProvidersA",
        constants$768.CryptEnumProvidersA$FUNC
    );
    ...
    static final MethodHandle CryptEnumProvidersW$MH = RuntimeHelper.downcallHandle(
        "CryptEnumProvidersW",
        constants$768.CryptEnumProvidersW$FUNC
    );
    ...
    static final MethodHandle CryptContextAddRef$MH = RuntimeHelper.downcallHandle(
        "CryptContextAddRef",
        constants$768.CryptContextAddRef$FUNC
    );
    ...
    static final MethodHandle CryptDuplicateKey$MH = RuntimeHelper.downcallHandle(
        "CryptDuplicateKey",
        constants$768.CryptDuplicateKey$FUNC
    );
    ...
    static final MethodHandle CryptDuplicateHash$MH = RuntimeHelper.downcallHandle(
        "CryptDuplicateHash",
        constants$768.CryptDuplicateHash$FUNC
    );
    ...
    static final MethodHandle GetEncSChannel$MH = RuntimeHelper.downcallHandle(
        "GetEncSChannel",
        constants$768.GetEncSChannel$FUNC
    );
}
