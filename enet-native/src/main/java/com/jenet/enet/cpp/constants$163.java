...
class constants$163 {
    ...
    static final MethodHandle TpSetCallbackFinalizationCallback$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.TpSetCallbackFinalizationCallback$FUNC
    );
    ...
    static final MethodHandle TpSetCallbackPriority$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.TpSetCallbackPriority$FUNC
    );
    ...
    static final MethodHandle TpSetCallbackPersistent$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.TpSetCallbackPersistent$FUNC
    );
    ...
    static final MethodHandle TpDestroyCallbackEnviron$MH = RuntimeHelper.downcallHandle(
        ...
        constants$163.TpDestroyCallbackEnviron$FUNC
    );
    ...
    static final MethodHandle PTP_WORK_CALLBACK$MH = RuntimeHelper.downcallHandle(
        constants$163.PTP_WORK_CALLBACK$FUNC
    );
}
