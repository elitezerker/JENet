...
class constants$89 {
    ...
    static final MethodHandle _InterlockedIncrement$MH = RuntimeHelper.downcallHandle(
        ...
        constants$89._InterlockedIncrement$FUNC
    );
    ...
    static final MethodHandle _InterlockedDecrement$MH = RuntimeHelper.downcallHandle(
        ...
        constants$89._InterlockedDecrement$FUNC
    );
    ...
    static final MethodHandle _InterlockedExchange$MH = RuntimeHelper.downcallHandle(
        ...
        constants$89._InterlockedExchange$FUNC
    );
    ...
    static final MethodHandle _InterlockedExchangeAdd$MH = RuntimeHelper.downcallHandle(
        ...
        constants$89._InterlockedExchangeAdd$FUNC
    );
    ...
    static final MethodHandle _InlineInterlockedAdd$MH = RuntimeHelper.downcallHandle(
        ...
        constants$89._InlineInterlockedAdd$FUNC
    );
    ...
    static final MethodHandle _InterlockedCompareExchange$MH = RuntimeHelper.downcallHandle(
        ...
        constants$89._InterlockedCompareExchange$FUNC
    );
}
