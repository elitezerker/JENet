...
public interface LPFNADDPROPSHEETPAGE {
    ...
    static MemorySegment allocate(LPFNADDPROPSHEETPAGE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPFNADDPROPSHEETPAGE.class, fi, constants$922.LPFNADDPROPSHEETPAGE$FUNC, session);
    }
    static LPFNADDPROPSHEETPAGE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$922.LPFNADDPROPSHEETPAGE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
