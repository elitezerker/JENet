...
import static java.lang.foreign.ValueLayout.*;
 class enet_h_35 extends enet_h_34 {
    ...
    public static MemoryAddress GR_GLOBAL() {
        return constants$1342.GR_GLOBAL$ADDR;
    }
    ...
    public static MemoryAddress GEO_NAME_USER_DEFAULT() {
        return constants$1342.GEO_NAME_USER_DEFAULT$ADDR;
    }
    public static MemoryAddress LOCALE_NAME_USER_DEFAULT() {
        return constants$1342.LOCALE_NAME_USER_DEFAULT$ADDR;
    }
    public static MemorySegment LOCALE_NAME_INVARIANT() {
        return constants$1342.LOCALE_NAME_INVARIANT$SEGMENT;
    }
    public static MemorySegment LOCALE_NAME_SYSTEM_DEFAULT() {
        return constants$1342.LOCALE_NAME_SYSTEM_DEFAULT$SEGMENT;
    }
    ...
    public static MemoryAddress VS_FILE_INFO() {
        return constants$1343.VS_FILE_INFO$ADDR;
    }
    ...
    public static MemoryAddress HKEY_CLASSES_ROOT() {
        return constants$1343.HKEY_CLASSES_ROOT$ADDR;
    }
    public static MemoryAddress HKEY_CURRENT_USER() {
        return constants$1343.HKEY_CURRENT_USER$ADDR;
    }
    public static MemoryAddress HKEY_LOCAL_MACHINE() {
        return constants$1343.HKEY_LOCAL_MACHINE$ADDR;
    }
    public static MemoryAddress HKEY_USERS() {
        return constants$1343.HKEY_USERS$ADDR;
    }
    public static MemoryAddress HKEY_PERFORMANCE_DATA() {
        return constants$1343.HKEY_PERFORMANCE_DATA$ADDR;
    }
    public static MemoryAddress HKEY_PERFORMANCE_TEXT() {
        return constants$1344.HKEY_PERFORMANCE_TEXT$ADDR;
    }
    public static MemoryAddress HKEY_PERFORMANCE_NLSTEXT() {
        return constants$1344.HKEY_PERFORMANCE_NLSTEXT$ADDR;
    }
    public static MemoryAddress HKEY_CURRENT_CONFIG() {
        return constants$1344.HKEY_CURRENT_CONFIG$ADDR;
    }
    public static MemoryAddress HKEY_DYN_DATA() {
        return constants$1344.HKEY_DYN_DATA$ADDR;
    }
    public static MemoryAddress HKEY_CURRENT_USER_LOCAL_SETTINGS() {
        return constants$1344.HKEY_CURRENT_USER_LOCAL_SETTINGS$ADDR;
    }
    public static MemoryAddress WIN31_CLASS() {
        return constants$1344.WIN31_CLASS$ADDR;
    }
    ...
    public static MemorySegment SZDDESYS_TOPIC() {
        return constants$1345.SZDDESYS_TOPIC$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_TOPICS() {
        return constants$1345.SZDDESYS_ITEM_TOPICS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_SYSITEMS() {
        return constants$1345.SZDDESYS_ITEM_SYSITEMS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_RTNMSG() {
        return constants$1345.SZDDESYS_ITEM_RTNMSG$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_STATUS() {
        return constants$1345.SZDDESYS_ITEM_STATUS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_FORMATS() {
        return constants$1345.SZDDESYS_ITEM_FORMATS$SEGMENT;
    }
    public static MemorySegment SZDDESYS_ITEM_HELP() {
        return constants$1346.SZDDESYS_ITEM_HELP$SEGMENT;
    }
    public static MemorySegment SZDDE_ITEM_ITEMLIST() {
        return constants$1346.SZDDE_ITEM_ITEMLIST$SEGMENT;
    }
    public static MemoryAddress CBR_BLOCK() {
        return constants$1346.CBR_BLOCK$ADDR;
    }
    ...
    public static MemorySegment ALL_TRANSPORTS() {
        return constants$1346.ALL_TRANSPORTS$SEGMENT;
    }
    public static MemorySegment MS_NBF() {
        return constants$1346.MS_NBF$SEGMENT;
    }
    ...
    public static MemoryAddress RPC_C_NO_CREDENTIALS() {
        return constants$1346.RPC_C_NO_CREDENTIALS$ADDR;
    }
    ...
    public static MemoryAddress RPC_CONTEXT_HANDLE_DEFAULT_GUARD() {
        return constants$1347.RPC_CONTEXT_HANDLE_DEFAULT_GUARD$ADDR;
    }
    ...
    public static MemoryAddress I_RRPCUNINITIALIZENDROLE_EXPORT_NAME() {
        return constants$1347.I_RRPCUNINITIALIZENDROLE_EXPORT_NAME$ADDR;
    }
