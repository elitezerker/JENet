...
public interface I_RpcPerformCalloutFn {
    ...
    static MemorySegment allocate(I_RpcPerformCalloutFn fi, MemorySession session) {
        return RuntimeHelper.upcallStub(I_RpcPerformCalloutFn.class, fi, constants$729.I_RpcPerformCalloutFn$FUNC, session);
    }
    static I_RpcPerformCalloutFn ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _Context, java.lang.foreign.MemoryAddress _CallOutState, int _Stage) -> {
            try {
                return (int)constants$729.I_RpcPerformCalloutFn$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_Context, (java.lang.foreign.Addressable)_CallOutState, _Stage);
            } catch (Throwable ex$) {
