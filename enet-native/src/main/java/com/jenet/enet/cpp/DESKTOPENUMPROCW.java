...
public interface DESKTOPENUMPROCW {
    ...
    static MemorySegment allocate(DESKTOPENUMPROCW fi, MemorySession session) {
        return RuntimeHelper.upcallStub(DESKTOPENUMPROCW.class, fi, constants$451.DESKTOPENUMPROCW$FUNC, session);
    }
    static DESKTOPENUMPROCW ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$451.DESKTOPENUMPROCW$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
