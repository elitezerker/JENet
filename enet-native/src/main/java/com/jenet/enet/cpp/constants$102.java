...
class constants$102 {
    ...
    static final MethodHandle OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$MH = RuntimeHelper.downcallHandle(
        constants$102.OUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$FUNC
    );
    ...
    static final MethodHandle POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$MH = RuntimeHelper.downcallHandle(
        constants$102.POUT_OF_PROCESS_FUNCTION_TABLE_CALLBACK$FUNC
    );
    ...
    static final MethodHandle PEXCEPTION_FILTER$MH = RuntimeHelper.downcallHandle(
        constants$102.PEXCEPTION_FILTER$FUNC
    );
