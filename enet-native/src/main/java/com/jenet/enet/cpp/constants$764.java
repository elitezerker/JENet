...
class constants$764 {
    ...
    static final MethodHandle CryptSetProvParam$MH = RuntimeHelper.downcallHandle(
        "CryptSetProvParam",
        constants$764.CryptSetProvParam$FUNC
    );
    ...
    static final MethodHandle CryptGetProvParam$MH = RuntimeHelper.downcallHandle(
        "CryptGetProvParam",
        constants$764.CryptGetProvParam$FUNC
    );
    ...
    static final MethodHandle CryptGenRandom$MH = RuntimeHelper.downcallHandle(
        "CryptGenRandom",
        constants$764.CryptGenRandom$FUNC
    );
    ...
    static final MethodHandle CryptGetUserKey$MH = RuntimeHelper.downcallHandle(
        "CryptGetUserKey",
        constants$764.CryptGetUserKey$FUNC
    );
    ...
    static final MethodHandle CryptExportKey$MH = RuntimeHelper.downcallHandle(
        "CryptExportKey",
        constants$764.CryptExportKey$FUNC
    );
    ...
    static final MethodHandle CryptImportKey$MH = RuntimeHelper.downcallHandle(
        "CryptImportKey",
        constants$764.CryptImportKey$FUNC
    );
}
