...
class constants$516 {
    ...
    static final MethodHandle GrayStringA$MH = RuntimeHelper.downcallHandle(
        "GrayStringA",
        constants$516.GrayStringA$FUNC
    );
    ...
    static final MethodHandle GrayStringW$MH = RuntimeHelper.downcallHandle(
        "GrayStringW",
        constants$516.GrayStringW$FUNC
    );
    ...
    static final MethodHandle TabbedTextOutA$MH = RuntimeHelper.downcallHandle(
        "TabbedTextOutA",
        constants$516.TabbedTextOutA$FUNC
    );
    ...
    static final MethodHandle TabbedTextOutW$MH = RuntimeHelper.downcallHandle(
        "TabbedTextOutW",
        constants$516.TabbedTextOutW$FUNC
    );
}
