...
public interface PFN_CMSG_STREAM_OUTPUT {
    ...
    static MemorySegment allocate(PFN_CMSG_STREAM_OUTPUT fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CMSG_STREAM_OUTPUT.class, fi, constants$789.PFN_CMSG_STREAM_OUTPUT$FUNC, session);
    }
    static PFN_CMSG_STREAM_OUTPUT ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pvArg, java.lang.foreign.MemoryAddress _pbData, int _cbData, int _fFinal) -> {
            try {
                return (int)constants$789.PFN_CMSG_STREAM_OUTPUT$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pvArg, (java.lang.foreign.Addressable)_pbData, _cbData, _fFinal);
            } catch (Throwable ex$) {
