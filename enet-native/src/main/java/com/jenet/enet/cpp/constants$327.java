...
class constants$327 {
    ...
    static final MethodHandle GlobalAddAtomExA$MH = RuntimeHelper.downcallHandle(
        "GlobalAddAtomExA",
        constants$327.GlobalAddAtomExA$FUNC
    );
    ...
    static final MethodHandle GlobalAddAtomExW$MH = RuntimeHelper.downcallHandle(
        "GlobalAddAtomExW",
        constants$327.GlobalAddAtomExW$FUNC
    );
    ...
    static final MethodHandle GlobalFindAtomA$MH = RuntimeHelper.downcallHandle(
        "GlobalFindAtomA",
        constants$327.GlobalFindAtomA$FUNC
    );
    ...
    static final MethodHandle GlobalFindAtomW$MH = RuntimeHelper.downcallHandle(
        "GlobalFindAtomW",
        constants$327.GlobalFindAtomW$FUNC
    );
    ...
    static final MethodHandle GlobalGetAtomNameA$MH = RuntimeHelper.downcallHandle(
        "GlobalGetAtomNameA",
        constants$327.GlobalGetAtomNameA$FUNC
    );
    ...
    static final MethodHandle GlobalGetAtomNameW$MH = RuntimeHelper.downcallHandle(
        "GlobalGetAtomNameW",
        constants$327.GlobalGetAtomNameW$FUNC
    );
}
