...
class constants$1266 {
    ...
    static final MethodHandle OpenSCManagerW$MH = RuntimeHelper.downcallHandle(
        "OpenSCManagerW",
        constants$1266.OpenSCManagerW$FUNC
    );
    ...
    static final MethodHandle OpenServiceA$MH = RuntimeHelper.downcallHandle(
        "OpenServiceA",
        constants$1266.OpenServiceA$FUNC
    );
    ...
    static final MethodHandle OpenServiceW$MH = RuntimeHelper.downcallHandle(
        "OpenServiceW",
        constants$1266.OpenServiceW$FUNC
    );
    ...
    static final MethodHandle QueryServiceConfigA$MH = RuntimeHelper.downcallHandle(
        "QueryServiceConfigA",
        constants$1266.QueryServiceConfigA$FUNC
    );
    ...
    static final MethodHandle QueryServiceConfigW$MH = RuntimeHelper.downcallHandle(
        "QueryServiceConfigW",
        constants$1266.QueryServiceConfigW$FUNC
    );
    ...
    static final MethodHandle QueryServiceConfig2A$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1266.QueryServiceConfig2A$FUNC
    );
}
