...
class constants$369 {
    ...
    static final MethodHandle CreateActCtxW$MH = RuntimeHelper.downcallHandle(
        "CreateActCtxW",
        constants$369.CreateActCtxW$FUNC
    );
    ...
    static final MethodHandle AddRefActCtx$MH = RuntimeHelper.downcallHandle(
        "AddRefActCtx",
        constants$369.AddRefActCtx$FUNC
    );
    ...
    static final MethodHandle ReleaseActCtx$MH = RuntimeHelper.downcallHandle(
        "ReleaseActCtx",
        constants$369.ReleaseActCtx$FUNC
    );
    ...
    static final MethodHandle ZombifyActCtx$MH = RuntimeHelper.downcallHandle(
        "ZombifyActCtx",
        constants$369.ZombifyActCtx$FUNC
    );
    ...
    static final MethodHandle ActivateActCtx$MH = RuntimeHelper.downcallHandle(
        "ActivateActCtx",
        constants$369.ActivateActCtx$FUNC
    );
    ...
    static final MethodHandle DeactivateActCtx$MH = RuntimeHelper.downcallHandle(
        "DeactivateActCtx",
        constants$369.DeactivateActCtx$FUNC
    );
}
