...
public interface PFN_CMSG_EXPORT_KEY_AGREE {
    ...
    static MemorySegment allocate(PFN_CMSG_EXPORT_KEY_AGREE fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CMSG_EXPORT_KEY_AGREE.class, fi, constants$794.PFN_CMSG_EXPORT_KEY_AGREE$FUNC, session);
    }
    static PFN_CMSG_EXPORT_KEY_AGREE ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _pContentEncryptInfo, java.lang.foreign.MemoryAddress _pKeyAgreeEncodeInfo, java.lang.foreign.MemoryAddress _pKeyAgreeEncryptInfo, int _dwFlags, java.lang.foreign.MemoryAddress _pvReserved) -> {
            try {
                return (int)constants$794.PFN_CMSG_EXPORT_KEY_AGREE$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_pContentEncryptInfo, (java.lang.foreign.Addressable)_pKeyAgreeEncodeInfo, (java.lang.foreign.Addressable)_pKeyAgreeEncryptInfo, _dwFlags, (java.lang.foreign.Addressable)_pvReserved);
            } catch (Throwable ex$) {
