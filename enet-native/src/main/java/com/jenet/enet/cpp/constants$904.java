...
class constants$904 {
    ...
    static final MethodHandle DeviceDsmGetOutputLength$MH = RuntimeHelper.downcallHandle(
        ...
        constants$904.DeviceDsmGetOutputLength$FUNC
    );
    ...
    static final MethodHandle DeviceDsmValidateOutputLength$MH = RuntimeHelper.downcallHandle(
        ...
        constants$904.DeviceDsmValidateOutputLength$FUNC
    );
    ...
    static final MethodHandle DeviceDsmGetOutputBlockLength$MH = RuntimeHelper.downcallHandle(
        ...
        constants$904.DeviceDsmGetOutputBlockLength$FUNC
    );
    ...
    static final MethodHandle DeviceDsmInitializeOutput$MH = RuntimeHelper.downcallHandle(
        ...
        constants$904.DeviceDsmInitializeOutput$FUNC
    );
    ...
    static final MethodHandle DeviceDsmValidateOutput$MH = RuntimeHelper.downcallHandle(
        ...
        constants$904.DeviceDsmValidateOutput$FUNC
    );
    ...
    static final MemorySegment FILE_TYPE_NOTIFICATION_GUID_PAGE_FILE$SEGMENT = RuntimeHelper.lookupGlobalVariable("FILE_TYPE_NOTIFICATION_GUID_PAGE_FILE", constants$904.FILE_TYPE_NOTIFICATION_GUID_PAGE_FILE$LAYOUT);
}
