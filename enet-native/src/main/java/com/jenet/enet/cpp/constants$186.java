...
class constants$186 {
    ...
    static final MethodHandle FindFirstStreamW$MH = RuntimeHelper.downcallHandle(
        "FindFirstStreamW",
        constants$186.FindFirstStreamW$FUNC
    );
    ...
    static final MethodHandle FindNextStreamW$MH = RuntimeHelper.downcallHandle(
        "FindNextStreamW",
        constants$186.FindNextStreamW$FUNC
    );
    ...
    static final MethodHandle AreFileApisANSI$MH = RuntimeHelper.downcallHandle(
        "AreFileApisANSI",
        constants$186.AreFileApisANSI$FUNC
    );
    ...
    static final MethodHandle GetTempPathA$MH = RuntimeHelper.downcallHandle(
        "GetTempPathA",
        constants$186.GetTempPathA$FUNC
    );
    ...
    static final MethodHandle FindFirstFileNameW$MH = RuntimeHelper.downcallHandle(
        "FindFirstFileNameW",
        constants$186.FindFirstFileNameW$FUNC
    );
    ...
    static final MethodHandle FindNextFileNameW$MH = RuntimeHelper.downcallHandle(
        "FindNextFileNameW",
        constants$186.FindNextFileNameW$FUNC
    );
}
