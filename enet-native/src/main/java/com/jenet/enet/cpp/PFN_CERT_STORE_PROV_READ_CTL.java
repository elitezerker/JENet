...
public interface PFN_CERT_STORE_PROV_READ_CTL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_READ_CTL fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PFN_CERT_STORE_PROV_READ_CTL.class, fi, constants$800.PFN_CERT_STORE_PROV_READ_CTL$FUNC, session);
    }
    static PFN_CERT_STORE_PROV_READ_CTL ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _hStoreProv, java.lang.foreign.MemoryAddress _pStoreCtlContext, int _dwFlags, java.lang.foreign.MemoryAddress _ppProvCtlContext) -> {
            try {
                return (int)constants$800.PFN_CERT_STORE_PROV_READ_CTL$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_hStoreProv, (java.lang.foreign.Addressable)_pStoreCtlContext, _dwFlags, (java.lang.foreign.Addressable)_ppProvCtlContext);
            } catch (Throwable ex$) {
