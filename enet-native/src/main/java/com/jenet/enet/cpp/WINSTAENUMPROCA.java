...
public interface WINSTAENUMPROCA {
    ...
    static MemorySegment allocate(WINSTAENUMPROCA fi, MemorySession session) {
        return RuntimeHelper.upcallStub(WINSTAENUMPROCA.class, fi, constants$450.WINSTAENUMPROCA$FUNC, session);
    }
    static WINSTAENUMPROCA ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress __x0, long __x1) -> {
            try {
                return (int)constants$450.WINSTAENUMPROCA$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
            } catch (Throwable ex$) {
