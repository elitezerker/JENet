...
class constants$1259 {
    ...
    static final MemorySegment NAMED_PIPE_EVENT_GUID$SEGMENT = RuntimeHelper.lookupGlobalVariable("NAMED_PIPE_EVENT_GUID", constants$1259.NAMED_PIPE_EVENT_GUID$LAYOUT);
    ...
    static final MemorySegment CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID$SEGMENT = RuntimeHelper.lookupGlobalVariable("CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID", constants$1259.CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID$LAYOUT);
    ...
    static final MethodHandle SERVICE_MAIN_FUNCTIONW$MH = RuntimeHelper.downcallHandle(
        constants$1259.SERVICE_MAIN_FUNCTIONW$FUNC
    );
    ...
    static final MethodHandle SERVICE_MAIN_FUNCTIONA$MH = RuntimeHelper.downcallHandle(
        constants$1259.SERVICE_MAIN_FUNCTIONA$FUNC
    );
}
