...
public class _ENetProtocolSendReliable {
    ...
    public static MemoryLayout $LAYOUT() {
        return _ENetProtocolSendReliable.$struct$LAYOUT;
    }
    ...
    public static VarHandle dataLength$VH() {
        return _ENetProtocolSendReliable.dataLength$VH;
    }
    public static short dataLength$get(MemorySegment seg) {
        return (short)_ENetProtocolSendReliable.dataLength$VH.get(seg);
    }
    public static void dataLength$set( MemorySegment seg, short x) {
        _ENetProtocolSendReliable.dataLength$VH.set(seg, x);
    }
    public static short dataLength$get(MemorySegment seg, long index) {
        return (short)_ENetProtocolSendReliable.dataLength$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void dataLength$set(MemorySegment seg, long index, short x) {
        _ENetProtocolSendReliable.dataLength$VH.set(seg.asSlice(index*sizeof()), x);
    }
