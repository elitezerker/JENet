...
public interface I_RpcProxyFilterIfFn {
    ...
    static MemorySegment allocate(I_RpcProxyFilterIfFn fi, MemorySession session) {
        return RuntimeHelper.upcallStub(I_RpcProxyFilterIfFn.class, fi, constants$730.I_RpcProxyFilterIfFn$FUNC, session);
    }
    static I_RpcProxyFilterIfFn ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _Context, java.lang.foreign.MemoryAddress _IfUuid, short _IfMajorVersion, java.lang.foreign.MemoryAddress _fAllow) -> {
            try {
                return (int)constants$730.I_RpcProxyFilterIfFn$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_Context, (java.lang.foreign.Addressable)_IfUuid, _IfMajorVersion, (java.lang.foreign.Addressable)_fAllow);
            } catch (Throwable ex$) {
