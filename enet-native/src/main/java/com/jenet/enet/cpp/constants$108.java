...
class constants$108 {
    ...
    static final MethodHandle ReadUCharRaw$MH = RuntimeHelper.downcallHandle(
        "ReadUCharRaw",
        constants$108.ReadUCharRaw$FUNC
    );
    ...
    static final MethodHandle WriteUCharRelease$MH = RuntimeHelper.downcallHandle(
        "WriteUCharRelease",
        constants$108.WriteUCharRelease$FUNC
    );
    ...
    static final MethodHandle WriteUCharNoFence$MH = RuntimeHelper.downcallHandle(
        "WriteUCharNoFence",
        constants$108.WriteUCharNoFence$FUNC
    );
    ...
    static final MethodHandle WriteBooleanRelease$MH = RuntimeHelper.downcallHandle(
        "WriteBooleanRelease",
        constants$108.WriteBooleanRelease$FUNC
    );
    ...
    static final MethodHandle WriteBooleanNoFence$MH = RuntimeHelper.downcallHandle(
        "WriteBooleanNoFence",
        constants$108.WriteBooleanNoFence$FUNC
    );
    ...
    static final MethodHandle WriteUCharRaw$MH = RuntimeHelper.downcallHandle(
        "WriteUCharRaw",
        constants$108.WriteUCharRaw$FUNC
    );
}
