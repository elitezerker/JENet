...
public interface LPSERVICE_MAIN_FUNCTIONW {
    ...
    static MemorySegment allocate(LPSERVICE_MAIN_FUNCTIONW fi, MemorySession session) {
        return RuntimeHelper.upcallStub(LPSERVICE_MAIN_FUNCTIONW.class, fi, constants$1260.LPSERVICE_MAIN_FUNCTIONW$FUNC, session);
    }
    static LPSERVICE_MAIN_FUNCTIONW ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (int _dwNumServicesArgs, java.lang.foreign.MemoryAddress _lpServiceArgVectors) -> {
            try {
                constants$1260.LPSERVICE_MAIN_FUNCTIONW$MH.invokeExact((Addressable)symbol, _dwNumServicesArgs, (java.lang.foreign.Addressable)_lpServiceArgVectors);
            } catch (Throwable ex$) {
