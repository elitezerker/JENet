...
public interface PGET_SYSTEM_WOW64_DIRECTORY_A {
    ...
    static MemorySegment allocate(PGET_SYSTEM_WOW64_DIRECTORY_A fi, MemorySession session) {
        return RuntimeHelper.upcallStub(PGET_SYSTEM_WOW64_DIRECTORY_A.class, fi, constants$333.PGET_SYSTEM_WOW64_DIRECTORY_A$FUNC, session);
    }
    static PGET_SYSTEM_WOW64_DIRECTORY_A ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _lpBuffer, int _uSize) -> {
            try {
                return (int)constants$333.PGET_SYSTEM_WOW64_DIRECTORY_A$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_lpBuffer, _uSize);
            } catch (Throwable ex$) {
